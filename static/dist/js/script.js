...
async function fetchPromptResponse(prompt) {
    // Ne prenez pas le texte "JPT est en train de réfléchir..." dans l'historique
    // Envoyez seulement le prompt actuel ou filtrez la liste
    const response = await fetch("/prompt", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ message: [prompt] }), // On envoie juste le dernier prompt pour tester
    });
